...
export class NavService {
  ...
  menuItems: Menu[] = [
    ...
    },
    {
      ...
      active: true,
      children: [
        { path: "/dashboard/minimal", title: "Minimal", type: "link" },
    ...
    { level: 1, id: 13, path: "/calender", bookmark: true, title: "Calender", icon: "calendar", type: "link" },
    { level: 1, id: 14, path: "/social-app", title: "Social App", icon: "social", type: "link" },
    { level: 1, id: 15, path: "/todo", title: "To-Do", icon: "to-do", type: "link" },
    ...
    { level: 1, id: 24, path: "/sample-page", title: "Sample Page", icon: "sample-page", type: "link" },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: "https://admin.pixelstrap.net/zono/template/basic-template.html",
              title: "Basic Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/zono/template/email-header.html",
              title: "Basic With Header",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/zono/template/template-email.html",
              title: "Ecomerce Template",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/zono/template/template-email-2.html",
              title: "Email Template 2",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/zono/template/ecommerce-templates.html",
              title: "Ecommerce Email",
              type: "extTabLink",
            },
            {
              path: "https://admin.pixelstrap.net/zono/template/email-order-success.html",
              title: "Order Success",
              type: "extTabLink",
            },
          ],
  ...
  horizontalMenu: Menu[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { level: 1, id: 10, path: "/bookmarks", title: "Bookmarks", type: "link" },
        { level: 1, id: 11, path: "/contacts", title: "Contact", type: "link" },
        { level: 1, id: 12, path: "/task", title: "Tasks", type: "link" },
        { level: 1, id: 13, path: "/calender", title: "Calender", type: "link" },
        { level: 1, id: 14, path: "/social-app", title: "Social App", type: "link" },
        { level: 1, id: 15, path: "/todo", title: "To-Do", type: "link" },
        { level: 1, id: 16, path: "/search-pages", title: "Search Result", type: "link" },
      ]
    },
    {
      title: "Pages",
      children: [
        { level: 1, id: 24, path: "/sample-page", title: "Sample Page", type: "link" },
        {
          id: 25,
          level: 1,
          title: "Others",
    ...
    },
    {
      ...
      children: [
        ...
        { level: 1, id: 28, path: "/faq", title: "FAQ", icon: "faq", type: "link" },
        {
          id: 29,
          level: 1,
          title: "Job Search",
        ...
        { level: 1, id: 33, path: "/knowledgebase", title: "Knowledgebase", type: "link" },
        { level: 1, id: 34, path: "/support-ticket", title: "Support Ticket", type: "link" },
      ]
    }
  ]
